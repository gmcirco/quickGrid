...
decaying rapidly as distance from a liquor store increases.
...
observed, while values below one imply fewer crimes are predicted than observed.
...
There is also the option to plot evaluations across a range of hotspot values. This helps to identify the performace of
